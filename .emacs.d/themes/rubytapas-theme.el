;;; color-theme-rubytapas.el --- RubyTapas color theme
;;
;; Note: Based on the molokai color theme by Adam Lloyd, which is
;; based on the molokai theme for vim by Tomas Restrepo, which is in
;; turn based on the monokai theme for textmate by Wimer Hazenberg and
;; a darker variant by Hamish Stuart Macpherson.
